package org.vaadin.example.views.student;
...
import org.vaadin.example.views.student.factory.StudentListLayoutFactory;
import org.vaadin.example.views.student.factory.StudentMainLayoutFactory;
...
public class StudentView extends VerticalLayout implements NavigationCrudListener{
	...
	public void navigateNextPage(ActionPage actionPage) {
		...
		case 0:
			studentMainLayoutFactory.refresh(Optional.ofNullable(actionPage.getDtoObject()));;
			break;
		case 1:
			studentListLayoutFactory.refresh();
			break;
		default:
			break;
		}
